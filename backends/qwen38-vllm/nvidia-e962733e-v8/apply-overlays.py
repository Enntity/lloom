#!/usr/bin/env python3
"""Apply the reviewed Q38FN v8 PLE/QSA fusion overlays.

This is the post-baseline layer: run it AFTER
``nvidia-e962733e/apply-overlays.py`` and
``nvidia-e962733e-prefix/apply-prefix-fixes.py``. It backports vLLM PR 55309
(PLE residual fusion and fused QSA output gate, including the follow-up
round-off fix) as whole-file overlays guarded by exact SHA256 hashes of the
post-baseline sources. Only the pinned vLLM revision is accepted.
"""
