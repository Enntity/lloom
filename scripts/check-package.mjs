...
const requiredFiles = [
  ...
  'package.json',
  'clients/examples/research-workers/runner.mjs',
  'clients/examples/research-workers/process.mjs',
  'clients/examples/research-workers/process-guard.mjs',
  'clients/examples/research-workers/models.json',
  'clients/examples/research-workers/profiles.json',
  'docs/research-workers.md',
  'bin/lloom.mjs',
  'bin/lloom-host.mjs',
...
try {
  ...
  if (health?.data?.recipeCount !== 42 || health?.data?.benchmarkCount !== 12) {
